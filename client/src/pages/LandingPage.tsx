      ...
      <Navbar />
        ...
        <main className="flex-grow flex flex-col items-center justify-center px-4 text-center ">
          ...
          <p className="mt-6 text-gray-600 dark:text-gray-400 max-w-lg">
            smartClip is revolutionizing how you interact with video content.
            Our platform allows you to extract the most valuable parts of any
            video, save them for later, and understand them better with
