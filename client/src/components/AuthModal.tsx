...
export default function AuthModal({ isOpen, onClose, onSubmit, onGoogle }:any) {
    ...
    >
      ...
      >
        ...
        <div className="relative mb-4">
          ...
          />
          <button className="absolute cursor-pointer inset-y-0 right-3 flex items-center text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
            {/* eye icon */}
